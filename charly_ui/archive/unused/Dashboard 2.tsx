  ...
  useEffect(() => {
    const initializeAuthentication = async () => {
      try {
        ...
        setAuthError("Initializing authentication...");
        
        // Clear any partial auth state and continue
        authService.logout();
        
        // Continue with fetch attempts - the authenticatedRequest will handle auth errors gracefully
        fetchKPIs();
        fetchRecentActivity();
        fetchAnalytics();
        fetchAIInsights();
        
        // Clear the auth error after a delay
          ...
          <div className="relative inline-block">
            ...
            <select 
              ...
              onChange={(e) => {
                ...
                handleExportData(e.target.value as 'csv' | 'pdf' | 'excel');
              }}
            >
