...
import { IntelligentCanvas, type CanvasMode } from '@/components/v2/IntelligentCanvas';
import { Button } from '@/components/v2/Button';
import { Card, CardHeader, CardTitle, CardDescription, CardContent, MetricCard, FeatureCard } from '@/components/v2/Card';
import { Accordion, ExpandableCard, StepDisclosure } from '@/components/v2/ProgressiveDisclosure';
